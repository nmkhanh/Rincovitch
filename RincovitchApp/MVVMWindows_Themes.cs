...
namespace RincovitchApp
{
  ...
  {
    public static readonly string GenericDict = "pack://application:,,,/RincovitchApp;component/UITheme/BaseTheme.xaml";
    public static readonly string DarkDict = "pack://application:,,,/RincovitchApp;component/UITheme/DarkTheme.xaml";
    public static readonly string LightDict = "pack://application:,,,/RincovitchApp;component/UITheme/LightTheme.xaml";
